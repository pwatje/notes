 ...
 */
export declare const usePaginationItems: (currentPage: number, totalPages: number, hasMorePages: boolean, siblingCount: number, currentPageLabel: string, pageLabel: string, previousLabel: string, nextLabel: string, onNext: () => void, onPrevious: () => void, onChange: (newPageIdx: number, prevPageIdx: any) => void) => JSX.Element[];
